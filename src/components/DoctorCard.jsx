...
export default function DoctorCard({ doctor }) {
  ...
  return (
    <div
      key={doctor.id}
      className="group relative flex flex-col justify-between rounded-2xl border border-slate-200/80 bg-white p-4 pt-0  m-1 shadow-[0_2px_8px_rgba(15,23,42,0.04)] transition-all duration-300 hover:border-slate-300 hover:shadow-[0_12px_24px_rgba(15,23,42,0.08)]"
    >
      <div>
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="relative -mt-4 -ml-8 h-28 w-28 shrink-0 rounded-full border-[5px] border-white bg-slate-100 shadow-lg ring-1 ring-slate-900/5">
