...
export default function MultiStepForm() {
  ...
  return (
    <div className="flex min-h-[500px] w-full items-center justify-center  p-3 font-sans text-slate-900 md:p-8">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-slate-200/80 bg-white/95 shadow-[0_20px_60px_-15px_rgba(15,23,42,0.08)] backdrop-blur-md md:[clip-path:polygon(0_0,_100%_0,_100%_calc(100%-28px),_100%_98%,_0_calc(100%-28px))]" >
